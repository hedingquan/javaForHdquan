...
<html>
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-0" data-genuitec-path="/Shiro02/WebRoot/index.jsp">
 	<shiro:hasPermission name="item:query"></shiro:hasPermission>
  </body>
</html>
