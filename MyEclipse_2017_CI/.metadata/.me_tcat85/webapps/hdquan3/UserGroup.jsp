...
<html>
  ...
  <script type="text/javascript">
	...
	function UserGroupAddRoles(){
		$('#win1').window('open',true);
  				...
  				var permissionTree = permission.combotree({
  					lines : true,
  					url : 'getPermissionByUserGroup.action',
  					checkbox : true,
  					width : '600px',
  					textField : 'name',
  					multiple : true
 ...
 <body  class="easyui-layout" data-options="fit:true"" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-3" data-genuitec-path="/hdquan3/WebRoot/UserGroup.jsp">
	 <div data-options="region:'north',title:'North Title',split:true" style="height:70px;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-3" data-genuitec-path="/hdquan3/WebRoot/UserGroup.jsp">
