...
$(function(){
 ...
 if ($('#qq').form('validate')) {
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-5" data-genuitec-path="/hdquan3/WebRoot/center.jsp">
  <div class="easyui-layout" fit="true" border="false" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-5" data-genuitec-path="/hdquan3/WebRoot/center.jsp"> 
	   ...
	   <form id="qq">
		      ...
		      <label for="userid">用户id</label>
		       <input class="easyui-textbox" type="text" name="userid" id="userid"/>
	   			...
	   			<div style="margin-bottom:20px" align="center">
		      <label for="role">为用户分配角色集合</label>
