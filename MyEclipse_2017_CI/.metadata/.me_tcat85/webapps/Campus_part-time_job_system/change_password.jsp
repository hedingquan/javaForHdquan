...
<html>
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-7" data-genuitec-path="/Campus_part-time_job_system/WebRoot/change_password.jsp">
		修改密码
		<form action="change_myinfo.action" method="post" style="text-align:center" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-7" data-genuitec-path="/Campus_part-time_job_system/WebRoot/change_password.jsp">
