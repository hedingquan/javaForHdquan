...
<html>
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-0" data-genuitec-path="/SpringMVC2/WebRoot/index.jsp">
   <form action="demo7" method="post" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-0" data-genuitec-path="/SpringMVC2/WebRoot/index.jsp">
