  ...
  <script type="text/javascript">
	...
	console.info(rows);
		$('#win1').window('open',true);
  				...
  				var permission = f.find('input[name=permission]');
  				var permissionTree = permission.combotree({
  					url : 'permissionByDepartment.action',
  					checkbox : true,
  					width:400,
  					queryParams : {number1 : rows.attributes.department_number1},
  					textField : 'name',
  					valueField :'id',
  					multiple : true
  				});
  		f.form('load',{
  			...
  			id : rows.id,
  			department_number1 : rows.attributes.department_number1
  		});
	}
	...
	<div id="win" class="easyui-window" title="addUserGroup" style="width:600px;height:400px" closed='true'
	   ...
	   <div style="margin-bottom:20px">
			<input class="easyui-textbox" data-options="
					...
					iconAlign:'right'" 
					style="width:300px;width:100%;" name="department_number1" id="department_number1"/>
			</div>
	   <div style="margin-bottom:20px">
			<input class="easyui-textbox" data-options="
					label: '用户组Id',
	   ...
	   data-options="iconCls:'icon-save',modal:true">
		 <form id="oo" method="post">
    		 <div>
		      ...
		      <div>
		    	<div style="margin-bottom:20px" align="center">
		      <label for="role">修改该用户组拥有角色:</label>
